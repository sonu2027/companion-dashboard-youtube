...
function App() {
  ...
  const loginWithGoogle = () => {
    window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${import.meta.env.VITE_CLIENT_ID}&redirect_uri=http://localhost:5173/auth/callback&response_type=token&scope=https://www.googleapis.com/auth/youtube.force-ssl&prompt=consent`;
